...
class Offset:
    def __init__(self):
        ...
        self.CharacterScreen = self.CharacterScreen()
        self.Warden = self.Warden()
        self.Buffs = self.Buffs()
        self.Item = self.Item()
        self.ObjectManager = self.ObjectManager()
        self.Misc = self.Misc()
        self.Party = self.Party()
        self.Player = self.Player()
        self.PlayerObject = self.PlayerObject()
        self.Unit = self.Unit()
    ...
    class Player:
        ...
        CorpsePositionX = 0x00B4E284
        CorpsePositionY = 0x00B4E288
        CorpsePositionZ = 0x00B4E28C
        ...
        MovementStruct = 0x9A8

        IsLooting = 0xB71B48
        IsInCC = 0xB4B3E4

        RealZoneText = 0xB4B404
        ContinentText = 0x00C961A0
        MinimapZoneText = 0xB4DA28

    class Warden:
        WardenPtr1 = 0x0CE8978
        WardenMemScanStart = 0x2a7f
        WardenPageScan = 0x2B21

    class CharacterScreen:
        Pointer = 0xB42144
        Size = 0x120
        NumCharacter = Pointer - 0x4
        LoginState = 0xB41478
    ...
    class Misc:
        ...
        AntiDc = 0x00B41D98
        LoginState = 0xB41478
        RealmName = 0x00C27FC1
        CGInputControlActive = 0xBE1148

    class Hooks:
        ChatMessage = 0x0049A7C9
        ErrorEnum = 0x00496807
        UpdateSpells = 0x004B302A
        SignalEvent_0 = 0x00703E72
        SignalEvent = 0x00703F76

    class Functions:
        SelectCharacter = 0x472740
        CastAtPos = 0x6E60F0
        EnterWorld = 0x0046B500
        GetCreatureRank = 0x00605620
        GetCreatureType = 0x00605570
        CastSpellByName = 0x004B4AB0

        RetrieveCorpse = 0x0048D260
        RepopMe = 0x005E0AE0

        LootSlotAt = 0x004C2790
        IsTransport = 0x007C61C0
        ConfirmBindLoot = 0x0048DD00

        CanCompleteQuest = 0x4DF580
        CanUseItem = 0x005EA930

        UnitReaction = 0x006061E0
        SetTarget = 0x493540
        LastHardwareAction = 0x00CF0BC8
        AutoLoot = 0x4C1FA0
        ClickToMove = 0x00611130
        AcceptQuest = 0x005EAC10
        CompleteQuest = 0x005EACA0
        GetText = 0x703BF0
        DoString = 0x00704CD0
        ...
        EnumVisibleObjects = 0x00468380
        BuyVendorItem = 0x005E1E90
        GetPtrForGuid = 0x464870
        ClntObjMgrGetActivePlayer = 0x00468550
        ClntObjMgrGetMapId = 0x00468580
        NetClientSend = 0x005379A0
        GetSpellCooldown = 0x006E13E0
        GetSpellCooldownPtr1 = 0x00CECAEC
        UseItem = 0x005D8D00
        DbQueryCreatureCache = 0x00556AA0
        DbQueryCreatureCachePtr1 = 0x00C0E354
        ClientConnection = 0x005AB490

        SellItem = 0x005E1D50

        LuaGetArgCount = 0x006F3070
        HandleSpellTerrainClick = 0x6E60F0

        DefaultServerLogin = 0x0046D160

        IsSceneEnd = 0x005A17A0
        EndScenePtr1 = 0x38a8
        EndScenePtr2 = 0xa8

        ItemCacheGetRow = 0x0055BA30
        ItemCacheBasePtr = 0x00C0E2A0

        QuestCacheGetRow = 0x00562A40
        QuestCacheBasePtr = 0x00C0E1B0

        LuaRegisterFunc = 0x00704120
        LuaUnregFunc = 0x00704160
        LuaIsString = 0x006F3510
        LuaIsNumber = 0x006F34D0
        LuaToString = 0x006F3690
        LuaToNumber = 0x006F3620

        Intersect = 0x6aa160

        CastSpell = 0x6E5A90
        AbandonQuest = 0x5EAF40
        GetGameObjectPosition = 0x005F9F50
    ...
    class ObjectManager:
        def __init__(self):
            self.CurObjGuid = 0x30
            self.ManagerBase = 0x00B41414
            self.PlayerGuid = 0xc0
            self.FirstObj = 0xac
            self.NextObj = 0x3c
            self.ObjType = 0x14
            self.DescriptorOffset = 0x8

    class PlayerObject:
        NameBase = 0xC0E230
        NameBaseNextGuid = 0xc
    ...
    class Unit:
        def __init__(self):
            ...
            self.PosZ = 0x9BC + 4
            self.AuraBase = 0xBC
            self.DebuffBase = 0x13C

            self.NameBase = 0xB30
            self.IsCritterOffset = 24
    ...
    class Item:
        UseItemPtr1 = 0xABE8
        ItemCachePtrQuality = 0x1C
        ItemCachePtrName = 0x8
    ...
    class Buffs:
        def __init__(self):
            self.FirstBuff = 0xBC
            self.FirstDebuff = 0x13C
            self.NextBuff = 0x4

    class Hacks:
        def __init__(self):
            self.DisableCollision = 0x6ABC5A
            self.CtmPatch = 0x860A90
            self.Wallclimb = 0x0080DFFC
            self.Collision3 = 0x006ABF13
            self.LootPatch = 0x004C21C0
            self.LootPatch2 = 0x004C28FF
            self.LuaUnlock = 0x494A50
